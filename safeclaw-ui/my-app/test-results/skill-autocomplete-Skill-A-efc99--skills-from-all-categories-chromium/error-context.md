...
- Name: skill-autocomplete.spec.ts >> Skill Autocomplete >> autocomplete contains skills from all categories
- Location: tests/e2e/skill-autocomplete.spec.ts:128:7
