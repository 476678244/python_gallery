...
**侧边栏组件** (`streamlit_ui/components/sidebar.py`)
```python
def render_sidebar():
    """渲染侧边栏"""
    with st.sidebar:
...
**记忆浏览页** (`streamlit_ui/pages/01_📚_Memory.py`)
```python
import streamlit as st
...
**自定义 CSS** (`streamlit_ui/styles/custom.css`)
```css
/* 主题色 */
:root {
