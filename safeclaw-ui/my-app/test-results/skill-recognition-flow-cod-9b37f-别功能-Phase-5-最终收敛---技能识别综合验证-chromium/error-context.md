...
- Name: skill-recognition-flow-coding.spec.ts >> 🔄 Flow Coding: LLM Skill 识别功能 >> Phase 5: 最终收敛 - 技能识别综合验证
- Location: tests/e2e/skill-recognition-flow-coding.spec.ts:270:7
