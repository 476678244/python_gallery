...
2. skills/ - each subdirectory is a skill collection
...
class SkillScanner:
    ...
    def scan_all_skills(self) -> List[SkillIndexEntry]:
        ...
        3. skills/ - each subdirectory is a skill collection
        ...
        linked_skills_paths = [
            # Relative to scanner location (5 levels up: scanner.py -> skills -> core -> safe_claw -> project_root)
            Path(__file__).parent.parent.parent.parent / "linked_skills",
        ...
        if skills_root.exists():
            ...
            logger.warning(f"skills entry point not found: {skills_root}")
