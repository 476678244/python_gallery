...
- Name: skill-recognition-flow-coding.spec.ts >> 🔄 Flow Coding: LLM Skill 识别功能 >> Phase 3: Execution 面板显示技能调用
- Location: tests/e2e/skill-recognition-flow-coding.spec.ts:218:7
