...
- Name: skill-autocomplete.spec.ts >> Skill Autocomplete >> each category has at least one enabled skill in dropdown
- Location: tests/e2e/skill-autocomplete.spec.ts:229:7
