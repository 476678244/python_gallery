...
from safe_claw.core.tools import ToolManager
from safe_claw.core.skills import SkillsManager
...
from safe_claw.core.middlewares.prompt_logger import (
    PromptLoggerMiddleware,
    set_llm_call_logs_storage,
)

# Initialize the middleware with shared storage
set_llm_call_logs_storage(_llm_call_logs_lock, _llm_call_logs)
